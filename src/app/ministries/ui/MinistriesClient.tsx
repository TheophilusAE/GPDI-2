  ...
  return (
    <main className="section-pad">
      <div className="container-responsive">
        <h1 className="text-3xl sm:text-4xl font-semibold">Pelayanan</h1>
        <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {items.map((it, i) => (
            <motion.div key={it.title} initial={{ opacity: 0, y: 8 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.05 }} className="glass rounded-2xl p-6">
              <div className="h-12 w-12 rounded-lg bg-gradient-to-br from-[--brand-red-600] to-[--brand-blue-600] mb-3" />
